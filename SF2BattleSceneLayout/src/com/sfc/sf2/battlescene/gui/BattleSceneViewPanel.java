 ...
 * @author TiMMy
 */
public class BattleSceneViewPanel extends AbstractViewPanel<BattleSceneLayoutPanel> {

    /**
     * Creates new form ViewPanel
     */
    public BattleSceneViewPanel() {
        super();
        initComponents();
        init(jComboBoxScale, jCheckBoxGrid, jSpinnerItemsPerRow, colorPickerBG);
        
        if (colorPickerBG != null) {
            colorPickerBG.setColor(SettingsManager.getGlobalSettings().getBattleSceneBGColor());
        }
    }
    ...
    private void colorPickerBGColorChanged(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_colorPickerBGColorChanged
        ...
        SettingsManager.getGlobalSettings().setBattleSceneBGColor(colorPickerBG.getColor());
